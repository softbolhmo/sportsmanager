...
sm_gather_files('functions', array ('ajax', 'backend', 'backup', 'frontend', 'html', 'install'));
sm_gather_files('classes', array ('SportsManager', 'Backend', 'Frontend', 'Backend_Default', 'Frontend_Default', 'Club', 'Game', 'League', 'Location', 'Player', 'Scoresheet', 'Team', 'User', 'Role'));
